...
comes in. splice() allows us to do just that: remove any number of consecutive 
...
And remember, arrays are zero-indexed, so to indicate the first 
element of an array, we would use 0. splice()'s first parameter
